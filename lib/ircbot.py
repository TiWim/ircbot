...
from lib.irclib import SimpleIRCClient
from lib.irclib import nm_to_n, irc_lower
from lib.irclib import parse_channel_modes, is_channel
from lib.irclib import ServerConnectionError
    ...
    def _connect(self):
        ...
        try:
            self.connect(self.server_list[0][0],
                         ...
                         self._nickname,
                         password,
                         ircname=self._realname, ssl=ssl)
